    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("department_name", models.CharField(max_length=50, unique=True, verbose_name="Отдел")),
            ],
            options={
                "verbose_name": "Отдел",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ("id", models.BigAutoField(primary_key=True, serialize=False)),
                ("position_name", models.CharField(max_length=30, unique=True, verbose_name="Должность")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("is_verification", models.BooleanField(default=False, verbose_name="Проверен")),
                (
                    "department",
                    models.ForeignKey(
                        blank=True,
                ...
                ("role", models.ManyToManyField(blank=True, to="users.customgroup", verbose_name="Роль")),
                (
                    "user_permissions",
                    models.ManyToManyField(
                        blank=True,
